...
@section('title', 'Daftar Stok Bahan')
        ...
        <div class="table-responsive text-nowrap">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="card-title
                            d-flex align-items-center">Daftar Stok Bahan</h4>
                    </div>
                    @if ($blade_user->hasPermissionTo('can_create_admin_ingredient_stocks'))
                        <div class="col-md-6 text-end">
                            <a href="{{ route('admin.ingredients-stocks.create') }}" class="btn btn-default"><i
                            ...
                            <td>
                                <ul class="list-inline hstack gap-2 mb-0">
                                    @include('layouts.admin.partials.act_delete', [
                                        'title' => 'Stok Bahan',
                                        'href' => route('admin.ingredients-stocks.destroy', $item->id),
